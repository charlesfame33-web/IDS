...
body('The scheduling flowchart illustrates the complete flow from order '
...
# CONTENT_MARKER
save(r'c:\Users\ALEXIS\Desktop\SENPAI\AgriFlow_AI_Project_Report_Plain.docx')
